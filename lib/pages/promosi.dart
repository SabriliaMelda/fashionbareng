...
class PromosiScreen extends StatefulWidget {
  const PromosiScreen({super.key});

  @override
  State<PromosiScreen> createState() => _PromosiScreenState();
}

class _PromosiScreenState extends State<PromosiScreen> {
          ...
          child: Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.local_offer_outlined, color: kPurple, size: 20),
              ),
                  ...
                  _PrimaryMiniButton(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Buka detail promo (dummy)')),
                      );
                    },
                  ),
                ],
          ...
          child: Row(
            children: [
              Container(
                ...
                alignment: Alignment.center,
                child: const Icon(Icons.confirmation_number_outlined, color: kPurple, size: 20),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
              ...
              Column(
                ...
                children: [
                  ...
                  _GhostMiniButton(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Kode ${v.code} disalin (dummy)')),
                      );
                    },
                  ),
                  const SizedBox(height: 8),
                  _PrimaryMiniButton(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Terapkan voucher (dummy)')),
                      );
                    },
                  ),
                ],
            ...
            child: Row(
              children: [
                Container(
                  ...
                  alignment: Alignment.center,
                  child: const Icon(Icons.history_rounded, color: kPurple, size: 20),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(

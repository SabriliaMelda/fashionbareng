...
class KeuanganProyekScreen extends StatefulWidget {
  const KeuanganProyekScreen({super.key});

  @override
  State<KeuanganProyekScreen> createState() => _KeuanganProyekScreenState();
}

class _KeuanganProyekScreenState extends State<KeuanganProyekScreen> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _BookmarkFolder(
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.operasional),
                  ),
                  const SizedBox(width: 10),
                  _BookmarkFolder(
                    label: 'Pemasukan',
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.pemasukan),
                  ),
                  const SizedBox(width: 10),
                  _BookmarkFolder(
                    label: 'Pengeluaran',
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.pengeluaran),
                  ),
                  const SizedBox(width: 10),
                  _BookmarkFolder(
                    label: 'Promosi',
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.promosi),
                  ),
                  const SizedBox(width: 10),
                  _BookmarkFolder(
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.rencanaBelanja),
                  ),
                  const SizedBox(width: 10),
                  _BookmarkFolder(
                    label: 'Rugi Laba',
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.rugiLaba),
                  ),
                  const SizedBox(width: 10),
                  _BookmarkFolder(
                    label: 'Upah',
                    ...
                    onSelected: (_) => setState(() => _active = _FinanceMenu.upah),
                  ),
                ],
              ),
            ),
                        ...
                        children: [
                          Expanded(
                            child: _QuickAction(
                              ...
                              label: 'Tambah\nTransaksi',
                              onTap: () => _toast(context, 'Tambah transaksi (dummy)'),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: _QuickAction(
                              ...
                              label: 'Export\nPDF',
                              onTap: () => _toast(context, 'Export PDF (dummy)'),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: _QuickAction(
                              ...
                              label: 'Export\nExcel',
                              onTap: () => _toast(context, 'Export Excel (dummy)'),
                            ),
                          ),
                        ],
                      ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const SizedBox(width: 6),
        const Icon(Icons.chevron_right_rounded, size: 18, color: Color(0xFF6A707C)),
        const SizedBox(width: 6),
        Expanded(
          child: Text(
            right,
    ...
    return Row(
      children: [
        Container(
          ...
          alignment: Alignment.center,
          child: const Icon(Icons.receipt_long_outlined, color: kPurple, size: 20),
        ),
        const SizedBox(width: 10),
        Expanded(
          child: Column(

...
String formatBookmarkTitle(String raw) {
  ...
  const smallWords = {'dan', 'atau', 'di', 'ke', 'dari', 'untuk', 'pada', 'yang'};
              ...
              _HeaderIcon(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Menu Proyek')),
                  );
                },
              ),
            ],
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Icon(
              isFolder ? Icons.chevron_right_rounded : Icons.arrow_forward_ios_rounded,
              size: isFolder ? 22 : 16,

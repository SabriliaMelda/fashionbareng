...
class StatusTagihanUpahScreen extends StatefulWidget {
  const StatusTagihanUpahScreen({super.key});

  @override
  State<StatusTagihanUpahScreen> createState() => _StatusTagihanUpahScreenState();
}

class _StatusTagihanUpahScreenState extends State<StatusTagihanUpahScreen> {

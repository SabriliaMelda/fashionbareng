// jadwal.dart
import 'package:fashion_mobile/pages/jadwal_belanja.dart';
import 'package:fashion_mobile/pages/jadwal_kirim.dart';
import 'package:fashion_mobile/pages/jadwal_upah.dart';
import 'package:flutter/material.dart';
import 'jadwal_buat.dart';
import 'spk.dart';
import 'home.dart';
...
class _JadwalMenuGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final menus = [
      ...
      _JadwalMenuItem(
          label: 'Jadwal Belanja', icon: Icons.shopping_bag_outlined),

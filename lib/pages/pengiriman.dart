                  ...
                  return _ShipmentCard(
                    ...
                    onCopyResi: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Resi disalin: ${s.resi} (dummy)')),
                      );
                    },
                  );
                },
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.local_shipping_outlined, size: 18, color: kPurple),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
      ...
      child: Row(
        children: [
          Container(
            ...
            alignment: Alignment.center,
            child: const Icon(Icons.local_shipping_outlined, color: kPurple, size: 22),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              alignment: Alignment.center,
              child: const Icon(Icons.local_shipping_outlined, color: kPurple, size: 30),
            ),
            const SizedBox(height: 14),
            Text(
              msg,

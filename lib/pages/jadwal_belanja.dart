                    ...
                    children: [
                      ...
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => tag = _BelanjaTag.aksesoris),
                        ),
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => tag = _BelanjaTag.packaging),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => tag = _BelanjaTag.lainnya),
                        ),
                      ),
                      const SizedBox(width: 10),
                            ...
                            setState(() {
                              schedules.insert(
                                ...
                                _BelanjaSchedule(
                                  ...
                                  location: locC.text.trim().isEmpty ? '-' : locC.text.trim(),
                                  tag: tag,
                                ),
                              );
                              dots[selectedDay] = (dots[selectedDay] ?? [const Color(0xFF0095FF)]);
                            });
                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Jadwal ditambahkan (dummy)')),
                            );
                          },
                          child: Container(
                            height: 44,

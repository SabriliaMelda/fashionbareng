                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      onTap: () {
                        ...
                        Navigator.pop(context);
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Pengeluaran ditambahkan (dummy)')),
                        );
                      },
                      child: Container(
                        height: 44,
            ...
            child: _TabPill(
              ...
              onTap: () async {
                ...
                await Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const ListrikScreen()),
                );
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(
                        ...
                        color: isOut ? const Color(0xFFD32F2F) : const Color(0xFF2E7D32),
                        size: 20,
                      ),
                    ),
                    const SizedBox(width: 12),

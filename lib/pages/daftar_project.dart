...
class _DaftarProyekScreenState extends State<DaftarProyekScreen> {
  ...
  List<_Project> get _filtered {
    ...
    if (_filterIndex == 1) return base.where((p) => p.status == 'On Track').toList();
    if (_filterIndex == 2) return base.where((p) => p.status == 'Revisi').toList();
          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(999),
                border: Border.all(color: Colors.white.withOpacity(active ? 0.0 : 0.18)),
              ),
              child: Text(
                items[i],
                style: TextStyle(
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.arrow_forward_rounded, color: kPurple, size: 18),
                      ),
                    ],
                  ),
                ],

...
class JadwalBuatScreen extends StatefulWidget {
  const JadwalBuatScreen({super.key});

  @override
  State<JadwalBuatScreen> createState() => _JadwalBuatScreenState();
}

class _JadwalBuatScreenState extends State<JadwalBuatScreen> {

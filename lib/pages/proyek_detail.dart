...
import 'bookmark_menu_screen.dart';
import 'simple_placeholder_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final rootItems = <BookmarkItem>[
      ...
      BookmarkItem.action(
        ...
        icon: Icons.history_toggle_off_rounded,
        page: SimplePlaceholderPage(title: 'Nilai Harian/Borongan • $projectName'),
      ),
      BookmarkItem.action(
      ...
      BookmarkItem.folder(
        ...
        children: [
          BookmarkItem.action(
            ...
            page: SimplePlaceholderPage(title: 'Upload Foto Progress • $projectName'),
          ),
          BookmarkItem.action(
            title: 'Galeri foto',
            icon: Icons.photo_library_outlined,
            page: SimplePlaceholderPage(title: 'Galeri Foto Progress • $projectName'),
          ),
          BookmarkItem.action(
            title: 'Validasi foto',
      ...
      BookmarkItem.action(
        ...
        icon: Icons.history_toggle_off_rounded,
        page: SimplePlaceholderPage(title: 'Status Progress Disetujui • $projectName'),
      ),
      BookmarkItem.action(
      ...
      BookmarkItem.folder(
        ...
        children: [
          BookmarkItem.action(
            ...
            page: SimplePlaceholderPage(title: 'Daftar Pekerjaan • $projectName'),
          ),
          BookmarkItem.action(
            title: 'Rincian item',
          ...
          BookmarkItem.action(
            ...
            page: SimplePlaceholderPage(title: 'Catatan Lapangan • $projectName'),
          ),
        ],
      ),

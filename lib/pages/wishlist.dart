...
class _WishlistScreenState extends State<WishlistScreen> {
  ...
  Widget build(BuildContext context) {
    final filtered = _items.where((e) {
      ...
      return e.title.toLowerCase().contains(q) || e.store.toLowerCase().contains(q);
    }).toList();
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  const _AvatarCircle(url: 'https://picsum.photos/seed/me/120/120'),
                ],
              ),
            ),
              ...
              child: filtered.isEmpty
                ...
                itemBuilder: (context, i) {
                  ...
                  return _WishCard(
                    ...
                    onOpen: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Buka produk: ${item.title}')),
                      );
                    },
                    onRemove: () {
                      setState(() => _items.remove(item));
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Dihapus dari wishlist: ${item.title}')),
                      );
                    },
                    onAddToCart: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Masuk keranjang (dummy): ${item.title}')),
                      );
                    },
                  );
                },

...
class _PengeluaranScreenState extends State<PengeluaranScreen> {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _tab == _OutTab.bahanBaku ? 'Tambah Bahan Baku' : 'Tambah Pengeluaran',
                      ...
                      onTap: () {
                        ...
                        if (title.isEmpty || amt <= 0) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Judul & nominal wajib diisi')),
                          );
                          return;
                        }
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Data ditambahkan (dummy)')),
                        );
                      },
                      child: Container(
                        height: 44,
  ...
  Widget _buildInputMode() {
    return Column(
      key: const ValueKey('input_mode_expense'),
      children: [
  ...
  Widget _buildBahanBakuMode() {
    return Column(
      key: const ValueKey('bahan_baku_mode_expense'),
      children: [
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: const Icon(Icons.inventory_2_outlined, color: kPurple, size: 20),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(

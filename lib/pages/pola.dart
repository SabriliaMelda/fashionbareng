...
class PolaScreen extends StatefulWidget {
  const PolaScreen({super.key});

  @override
  State<PolaScreen> createState() => _PolaScreenState();
}

class _PolaScreenState extends State<PolaScreen> {
  @override
...
class _CreatePolaSheetState extends State<_CreatePolaSheet> {
  ...
  final List<String> _gayaOptions = [
    'T - Shirt',
    'Hoodie',
    'Jacket',
    'Kemeja',
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Gaya', style: TextStyle(fontWeight: FontWeight.w700)),
                const SizedBox(height: 6),
                _DropdownField(
                  value: _selectedGaya,
                  hint: 'T - Shirt',
                ...
                const Text('Size Grading', style: TextStyle(fontWeight: FontWeight.w700)),
                const SizedBox(height: 6),
                _DropdownField(
                  value: _selectedSize,
                  hint: '1 Size',

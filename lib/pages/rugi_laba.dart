...
class RugiLabaScreen extends StatefulWidget {
  const RugiLabaScreen({super.key});

  @override
  State<RugiLabaScreen> createState() => _RugiLabaScreenState();
}

class _RugiLabaScreenState extends State<RugiLabaScreen> {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => type = _RlType.pengeluaran),
                        ),
                      ),
                    ],
                  ),
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            setState(() {
                              ...
                              if (_tab == _RlTab.proyek1) _p1.insert(0, newItem);
                              if (_tab == _RlTab.proyek2) _p2.insert(0, newItem);
                              if (_tab == _RlTab.proyek3) _p3.insert(0, newItem);
                              if (_tab == _RlTab.total) _p1.insert(0, newItem); // default
                            });

                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Transaksi ditambahkan (dummy)')),
                            );
                          },
                          child: Container(
                            height: 44,
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    ...
                    color: isIn ? const Color(0xFF2E7D32) : const Color(0xFFD32F2F),
                    size: 20,
                  ),
                ),
                const SizedBox(width: 12),

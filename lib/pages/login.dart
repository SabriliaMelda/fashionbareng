import 'package:flutter/gestures.dart'; // ✅ WAJIB: Biar teks bisa diklik
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:fashion_mobile/services/api_service.dart';
import 'package:fashion_mobile/pages/home.dart';
import 'package:fashion_mobile/pages/register.dart'; // ✅ WAJIB: Biar kenal halaman Register
...
class _LoginState extends State<Login> {
  ...
  Future<void> _doLogin() async {
    ...
    try {
      final result = await ApiService().login(loginValue, password);
      ...
      if (result['status'] == 'success') {
        ...
        _toast(result['message'] ?? 'Login Gagal');
      }
    } catch (e) {
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 1, color: const Color(0xFFE8ECF4)),
                            ),
                        ...
                        Row(
                          children: [
                            Expanded(
                                child: Container(
                                    height: 1, color: const Color(0xFFE8ECF4))),
                        ...
                        // ===== 👇 BAGIAN PENTING: TOMBOL REGISTER YANG BISA DIKLIK 👇 =====
                        Center(
                          child: Text.rich(
                            TextSpan(
                              children: [

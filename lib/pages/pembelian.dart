                  ...
                  InkWell(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Riwayat & Ringkasan (dummy)')),
                      );
                    },
                    child: const Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.receipt_long_outlined, size: 18, color: kPurple),
                          SizedBox(width: 6),
                          Text(
                            'Riwayat',
                            style: TextStyle(
                ...
                itemBuilder: (context, i) {
                  ...
                  return _OrderCard(
                    ...
                    onPrimary: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('$label: ${o.id} (dummy)')),
                      );
                    },
                    onSecondary: () {
...
enum _OrderFilter { semua, menungguBayar, diproses, dikirim, selesai, dibatalkan }
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(999),
                              border: Border.all(color: item.statusColor.withOpacity(0.35)),
                            ),
                            child: Text(
                              item.statusText,
                              style: TextStyle(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              alignment: Alignment.center,
              child: const Icon(Icons.shopping_bag_outlined, color: kPurple, size: 30),
            ),
            const SizedBox(height: 14),
            Text(
              msg,

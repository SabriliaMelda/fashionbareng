                    ...
                    children: [
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => status = _KirimStatus.siap),
                        ),
                      ),
                      ...
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => status = _KirimStatus.dijemput),
                        ),
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => status = _KirimStatus.dikirim),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      Expanded(
                        child: _ChoicePill(
                          ...
                          onTap: () => setLocal(() => status = _KirimStatus.selesai),
                        ),
                      ),
                      const SizedBox(width: 10),
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            final newItem = _KirimSchedule(
                              time: timeC.text.trim().isEmpty ? '-' : timeC.text.trim(),
                              title: title,
                              desc: descC.text.trim().isEmpty ? '-' : descC.text.trim(),
                              pickup: pickupC.text.trim().isEmpty ? '-' : pickupC.text.trim(),
                              destination: destC.text.trim().isEmpty ? '-' : destC.text.trim(),
                              courier: courierC.text.trim().isEmpty ? '-' : courierC.text.trim(),
                              awb: awbC.text.trim().isEmpty ? '-' : awbC.text.trim(),
                              status: status,
                            ...
                            setState(() {
                              final list = List<_KirimSchedule>.from(_activeSchedules);
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Jadwal kirim ditambahkan (dummy)')),
                            );
                          },
                          child: Container(
                            height: 44,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: 30,
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFFDBC0F2) : Colors.transparent,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.access_time, size: 16, color: Color(0xE59A9A9A)),
                  ...
                  Row(
                    children: [
                      const Icon(Icons.place_outlined, size: 18, color: Color(0xFF575A66)),
                      ...
                      const Icon(Icons.more_vert, size: 18, color: Color(0xFFD8DEF3)),
                    ],
                  ),
                ],
              ),

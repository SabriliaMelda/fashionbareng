...
class RencanaBelanjaScreen extends StatefulWidget {
  const RencanaBelanjaScreen({super.key});

  @override
  State<RencanaBelanjaScreen> createState() => _RencanaBelanjaScreenState();
}

class _RencanaBelanjaScreenState extends State<RencanaBelanjaScreen> {
            ...
            children: [
              ...
              _SheetAction(
                ...
                onTap: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Ubah (dummy)')),
                  );
                },
              ),
              const SizedBox(height: 10),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                _MiniStat(
                  label: 'Kategori',
                  value: _tab == _PlanTab.marketplace ? 'Marketplace' : 'Lainnya',
                ),
              ],
            ),
          ],

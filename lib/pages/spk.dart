                  ...
                  return _SpkCard(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Buka detail: ${spk.nomor}')),
                      );
                    },
                  );
                },
        ...
        child: Row(
          children: [
            Container(
              ...
              alignment: Alignment.center,
              child: const Icon(Icons.description_outlined, color: kPurple, size: 22),
            ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                _TextFieldBox(controller: _judulC, hint: 'Contoh: Pembuatan Kaos'),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('SPK berhasil dibuat (placeholder)')),
                      );
                    },
                    child: const Text(
                      'Simpan',
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<_SpkStatus>(
          ...
          items: const [
            DropdownMenuItem(value: _SpkStatus.pending, child: Text('Menunggu')),
